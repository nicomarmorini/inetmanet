...
const std::list<ChannelControlExtended::HostEntryExtended>& ChannelControlExtended::getHostList()
{
    Enter_Method_Silent();
    return hosts;
}

const std::set<ChannelControlExtended::HostRef>& ChannelControlExtended::getNeighborSet(HostRef h)
{
    Enter_Method_Silent();
    return h->neighbors;

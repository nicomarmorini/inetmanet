...
class INET_API Ieee80211MgmtBase : public PassiveQueueBase, public INotifiable
{
  ...
  protected:
    ...
    public:
      long getNumDataFramesReceived() {return numDataFramesReceived;};
      long getNumDataFramesDropped() {return numDataFramesDropped;};
      long getDataQueueLength() {return dataQueue.length();};
      int getFrameCapacity() {return frameCapacity;};
      long getMgmtQueueLength() {return mgmtQueue.length();};

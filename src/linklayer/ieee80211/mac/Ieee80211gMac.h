...
class INET_API Ieee80211gMac : public WirelessMacBase, public INotifiable
{
  ...
  protected:
    ...
    long numSent;
    long numReceived;
    long numSelfReceived;
    long numSentBroadcast;
    long numReceivedBroadcast;
    long numAckSend;
	 long numReceivedOther;

	cStdDev frameLengths;
	cStdDev serviceTime;
  ...
  public:
    ...
    //@}
    long getNumCollision(){return numCollision;};
    long getNumRetry(){return numRetry;};
    long getNumSentWithoutRetry(){return numSentWithoutRetry;};
    long getNumSent(){return numSent;};
    long getNumReceived(){return numReceived;};
    long getNumSelfReceived(){return numSelfReceived;};
    double getMeanCW(){return cwStats.getMean();};
    double getMeanServiceTime() {return serviceTime.getMean(); };

...
double WiMAXPathLossReceptionModel::calculateReceivedPower(double pSend, double carrierFrequency, double distance)
{
	...
	ev <<"RadioPath pEmpfang:" << pEmpfang <<" pSend:"<< pSend<< " L_m:"<< L_m << " L_a:" <<L_a << endl;
